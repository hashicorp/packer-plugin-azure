...
type FlatConfig struct {
	...
	VirtualNetworkSubscription                 *string                            `mapstructure:"virtual_network_subscription" required:"false" cty:"virtual_network_subscription" hcl:"virtual_network_subscription"`
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"virtual_network_subscription":            &hcldec.AttrSpec{Name: "virtual_network_subscription", Type: cty.String, Required: false},
