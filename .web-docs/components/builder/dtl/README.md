...
Negotiate/NTLM auth by default, and Basic auth is typically rejected. Set
`winrm_use_ntlm = false` only for STIG/FIPS-hardened images that require disabling NTLM.
